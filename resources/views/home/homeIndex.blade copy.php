...
@section('content')
    ...
    <main class="container">
        <section id="jumbotron" class="flex">
        ...
        <section>
            <h2 class="md:text-heading2-semibold text-body-bold text-center">Apa saja spesifikasi tanah perumahan yang
                disediakan
                bluehouse ?
            </h2>

            <div class="max-w-5xl mx-auto grid grid-cols-2 gap-6" id="penjelasan-kriteria">
                <!-- Luas Tanah Card -->
                ...
                <div class=" p-6 border  rounded-md bg-blue-50">
                    ...
                    <ul class="list-disc ml-6">
                        <li>Tersedia (90-100% atau 0-100 meter)</li>
                        <li>Kurang Tersedia (50-90% atau 100-500 meter)</li>
                        <li>Tidak Tersedia (&lt;50% atau &gt;500 meter)</li>
                    </ul>
                </div>
                ...
                <div class=" p-6 border  rounded-md bg-blue-50">
                    ...
                    <ul class="list-disc ml-6">
                        ...
                        <li>Kurang Tersedia (Pasokan tidak konsisten dengan gangguan sesekali, tersedia dalam 100-500
                            meter ke jalur listrik terdekat)</li>
                ...
                <div class=" p-6 border  rounded-md bg-blue-50">
                    ...
                    <ul class="list-disc ml-6">
                        <li>
                            ...
                            <p>
                                Tanah yang hampir tidak memiliki kemiringan. Biasanya sangat baik untuk
                                pembangunan karena tidak memerlukan pekerjaan tanah yang signifikan.
                            </p>
                        ...
                        <li>
                            ...
                            <p>
                                Tanah dengan kemiringan sedang yang memerlukan perencanaan lebih untuk
                                pembangunan.
                            </p>
                        </li>
                        <li>
                            <strong>Sangat Miring (Kemiringan > 15%)</strong>
                            <p>Tanah dengan kemiringan tajam yang memerlukan teknik konstruksi khusus.
                            </p>
        ...
        <div class="p-4">
            ...
            <button id="generateAlternatifBtn" class="bg-blue-500 text-white px-4 py-2 rounded">Generate
                Alternatif</button>
        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#generateAlternatifBtn').click(function() {
                        ...
                        // console.log(selectedKriteriaIds);
