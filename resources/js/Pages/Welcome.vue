...
<template>
  <Head title="Welcome" />
  <div class="bg-primary-50 text-black/50 dark:bg-black dark:text-white/50">
    <img
      id="background"
    ...
    >
      <div class="lg:max-w-7xl relative w-full max-w-2xl px-6">
        <header
          class="lg:grid-cols-3 grid items-center grid-cols-2 gap-2 py-10"
        >
          <div class="lg:justify-center lg:col-start-2 flex">
            <svg
        ...
        <main class="mt-6">
          <div class="lg:grid-cols-2 lg:gap-8 grid gap-6">
            <a
              href="https://laravel.com/docs"
              id="docs-card"
              class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-primary-50 p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
            >
              <div
              ...
              <div class="lg:items-end relative flex items-center gap-6">
                <div
                  id="docs-card-content"
                  class="lg:flex-col flex items-start gap-6"
                >
                  <div
                  ...
                  <div class="sm:pt-5 lg:pt-0 pt-3">
                    <h2
                      class="dark:text-white text-xl font-semibold text-black"
                    >
                      Documentation
                    </h2>

                    <p class="/relaxed mt-4">
            ...
            <a
              ...
              class="flex items-start gap-4 rounded-lg bg-primary-50 p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
            >
              <div
                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16"
              >
              ...
              <div class="sm:pt-5 pt-3">
                <h2 class="dark:text-white text-xl font-semibold text-black">
                  Laracasts
                </h2>
            ...
            <div
              class="flex items-start gap-4 rounded-lg bg-primary-50 p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800"
            >
              <div
                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16"
              >
        ...
        <footer class="dark:text-white/70 py-16 text-center text-black">
