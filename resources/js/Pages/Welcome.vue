    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="lg:max-w-7xl relative w-full max-w-2xl px-6">
                <header class="lg:grid-cols-3 grid items-center grid-cols-2 gap-2 py-10">
                    ...
                    <div class="lg:grid-cols-2 lg:gap-8 grid gap-6">
                        <a href="https://laravel.com/docs" id="docs-card"
                            ...
                            <div class="lg:items-end relative flex items-center gap-6">
                                <div id="docs-card-content" class="lg:flex-col flex items-start gap-6">
                                    <div
                                    ...
                                    <div class="sm:pt-5 lg:pt-0 pt-3">
                                        <h2 class="dark:text-white text-xl font-semibold text-black">Documentation</h2>
                        ...
                        <a href="https://laracasts.com"
                            ...
                            <div class="sm:pt-5 pt-3">
                                <h2 class="dark:text-white text-xl font-semibold text-black">Laracasts</h2>
                        ...
                        <a href="https://laravel-news.com"
                            ...
                            <div class="sm:pt-5 pt-3">
                                <h2 class="dark:text-white text-xl font-semibold text-black">Laravel News</h2>
                        ...
                        <div
                            ...
                            <div class="sm:pt-5 pt-3">
                                <h2 class="dark:text-white text-xl font-semibold text-black">Vibrant Ecosystem</h2>
                ...
                <footer class="dark:text-white/70 py-16 text-sm text-center text-black">
