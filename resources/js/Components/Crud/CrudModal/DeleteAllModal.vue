  ...
  <div id="deleteAllModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
      ...
      <div class="relative p-4 text-center bg-primary-50 rounded-lg shadow dark:bg-gray-800 sm:p-5">
        <button type="button" data-modal-target="deleteAllModal" data-modal-hide="deleteAllModal"
        ...
        <form @submit.prevent="submitForm('deleteAll', _, store.category)">
          <div class="flex justify-center items-center space-x-4">
            <button type="button" data-modal-hide="deleteAllModal"
            ...
            <button type="submit" data-modal-hide="deleteAllModal"
