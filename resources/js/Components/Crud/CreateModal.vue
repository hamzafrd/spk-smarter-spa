        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Tambah Kriteria</h3>
                    <button type="button" @click="toggleModal('createProductModal')"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Masukan Nama Kriteria" v-model="formKriteria.nama">
