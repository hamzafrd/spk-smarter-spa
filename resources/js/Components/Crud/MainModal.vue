...
const { setKriteria, updatePositions, toggleModal, moveListItem, loadList } = storePinia
...
<template lang="html">
    ...
    <section class="bg-white dark:bg-gray-800 relative shadow-md h-full flex flex-col antialiased">
        <!-- Header -->
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div
                ...
                <button type="button" id="createProductModalButton" @click="toggleModal('createProductModal', true)"
                ...
                <div v-if="kriteriaList.length" class="flex items-center space-x-3 w-full md:w-auto">
                    ...
                    <div id="actionsDropdown"
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li>
                                ...
                                <a href="#" :class="massEdit ? 'block' : 'hidden'" type="button"
                                    @click="toggleModal('simpanPosisiModal', true)"
                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    Kembali ke awal
                                </a>
                            </li>
                        ...
                        <div class="py-1">
                            <a href="#" data-modal-target="deleteAllModal" @click="toggleModal('deleteAllModal', true)"
        ...
        <!-- Table Data -->
        <div v-if="kriteriaList.length" class="overflow-x-auto flex-1">
                                ...
                                <ul class="py-1 text-sm" :aria-labelledby="item.nama + item.id">
                                    <li>
                                        <button type="button" data-modal-target="updateProductModal"
                                            ...
                                            @click="setKriteria(item), toggleModal('updateProductModal', true)"
                                    ...
                                    <li>
                                        <button type="button" data-modal-target="deleteModal"
                                            ...
                                            @click="setKriteria(item), toggleModal('deleteModal', true)"
